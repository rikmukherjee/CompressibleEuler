module mod_file
	...
	real(kind=8),parameter::nu=5.0d-1
	real(kind=8),parameter::delta=1.00000000000000000000
	real(kind=8),parameter::tFinal=80000
    real,parameter::pi = 4.0*atan(1.0)  
    real(kind=8),parameter:: l  = N  
    real(kind=8),parameter:: D0 = 1.0
    real(kind=8),parameter:: rhobackground = 0.0
